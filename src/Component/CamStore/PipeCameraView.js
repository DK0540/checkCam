...
// import "./PipeCameraView.css"; // Change the CSS file name
...
const PipeCameraViewContainer = styled.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
const PipeCameraView = ({ onCapture, onClose }) => {
